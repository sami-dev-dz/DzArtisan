      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-2">
          ...
          <p className="text-sm font-bold text-slate-400">
            Signalez un problème lié à une intervention ou à un client.
          </p>
        </div>
        <Button
...
function NewComplaintForm({ onSuccess, onCancel }) {
  ...
  React.useEffect(() => {
    // Specifically fetch from /artisan/interventions for artisan
    ...
    <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-100 dark:border-white/5 p-8 space-y-6 shadow-xl">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          placeholder="Ex: Problème avec le client, annulation injustifiée..."
